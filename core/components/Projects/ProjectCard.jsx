            ...
            <article className="project-card p-relative ">
                <div className="project-card-wrapper ">
                    ...
                    <div className="tag-type">
                        <h4 className="tag-type-title" >{type == 'PERSONAL' ? "personal project" : `Build for : ${companyName && companyName}`}</h4>
                    </div>
                    <div className="project-card-actions d-flex justify-content-center align-items-center">
                        ...
                        <a href={link} target={"_blank"} className="btn-view dark-text">VIEW</a>
