...
import {
  ...
  CustomRightArrow,
  CustomLeftArrow,
} from "../components/Carousel/Tools";
  ...
  return (
    <section className="section intention-web-section flex-shrink-0 vw-100 vh-100 d-flex   ">
      ...
      <div className="m-title">
        <h2 className="section-title text-primary text-animation--intentions">
          INTENTIONS
        </h2>
        <p className="section-paragraph dark-text text-animation--intentions">
          In addition to contribute with my knowledge and learn in this web
          development journey. I want to transform innovative ideas in products
          that generate impact in the people by moderns technologies
        </p>
      </div>
      <h2 className=" subtitle-text subtitle-text--tech tech-text text-primary">
        TECHNOLOGIES
      </h2>
