...
const projectData = [
    ...
    },
    {
        ...
        description: "Do you know how  a neuron works ?. In this animation, explain to you.",
    ...
    {
        name: "Reemp",
        description: "web platform for drives social and environmental action in colombia ",
    ...
    {
        name: "Bimadino Web",
        description: "web platform pages about digital resources for computer science of Córdoba University",
    ...
    },
    {
        ...
        description: "Section landing page section about how to use the sony interactive control  for Play 4",
    ...
    {
        name: "STUDYROOMS-UI",
        description: "Online training platform for TIC professionals In this moment this proyect only aviable for desktop-device",
    ...
    },
    {
        ...
        description: "The object of this OVA is to teach about how an algorithm works , using interactive elements as games. This project is not finished yet, it is in development mode.",
    ...
    return (
        ...
        <section className="section project-section flex-shrink-0 vw-100 vh-100 d-flex">
            ...
            <div className="project-container w-100">
                <h2 className="section-title section-title--project text-animation--project text-primary">PROJECTS WORKED </h2>
